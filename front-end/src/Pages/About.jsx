...
const About = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <h1 className="text-4xl font-bold text-center">About E-learning</h1>
      <p className="text-center mt-4">
        E-learning is dedicated to transforming the way you learn. Our platform offers a variety of courses designed to help you achieve your goals.
      </p>
      ...
      <div className="mt-8">
        ...
        <p className="mt-2 text-lg text-center">
          Founded in 2021, E-learning started as a small initiative to make quality education accessible to everyone. Over the years, we have grown into a comprehensive platform offering a wide range of courses.
        </p>
      </div>
